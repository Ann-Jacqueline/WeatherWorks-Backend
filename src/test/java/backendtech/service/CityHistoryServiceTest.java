...
public class CityHistoryServiceTest {
    ...
    @BeforeEach
    void setUp() {
        owner = new CityHistoryOwner("User1");
        owner.setId(1L);
        CityHistory history1 = new CityHistory(true, "Berlin", 24, "12:00", false, owner);
        history1.setId(1L);
        CityHistory history2 = new CityHistory(false, "London", 15, "10:00", false, owner);
        history2.setId(2L);
