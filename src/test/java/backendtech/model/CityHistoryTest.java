...
public class CityHistoryTest {
    ...
    void testCityHistoryToString() {
        ...
        CityHistory cityHistory = new CityHistory(true, "Berlin", 22, "14:00", false, owner);

        // Erwarteter String, der das Ergebnis von toString() darstellt
        String expected = "CityHistory(id=null, setAsDefault=true, cityName=Berlin, temperature=22, localTime=14:00, deleted=false, owner=" + owner.toString() + ")";
